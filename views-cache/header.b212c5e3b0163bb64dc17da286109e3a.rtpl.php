...
<head>
    ...
    <link rel="stylesheet" href="res/site/css/not-found/not-found.css">
</head>
        ...
        <?php if( $login == 'online' ){ ?>
            <div class="perfil">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenu">
                    <li><a class="dropdown-item" href="/cetdabar/user-perfil">Perfil</a></li>
                    <li><a class="dropdown-item" href="/cetdabar/user-cursos">Meus cursos</a></li>
