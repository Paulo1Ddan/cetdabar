<?php if(!class_exists('Rain\Tpl')){exit;}?>
    ...
    <section class="banner">
        <img src="res/site/assets/banner/banner1.jpg" alt="">
        <img src="res/site/assets/banner/banner2.jpg" alt="">
        <img src="res/site/assets/banner/banner3.jpg" alt="">
        <img src="res/site/assets/banner/banner4.jpg" alt="">
    </section>
    <!-- Cursos -->
            ...
            <div class="containerCursos">
                <?php $counter1=-1;  if( isset($cursos) && ( is_array($cursos) || $cursos instanceof Traversable ) && sizeof($cursos) ) foreach( $cursos as $key1 => $value1 ){ $counter1++; ?>
                    <div class="curso" data-aos="fade-up" data-aos-duration="2000">
                        <div class="imgCurso">
                            <img src="res/site/<?php echo htmlspecialchars( $value1["imgcurso"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" alt="">
                        </div>
                        <div class="descCurso">
                            <div class="txtCurso">
                                <h3>
                            ...
                            <a href="cursos/<?php echo htmlspecialchars( $value1["idcurso"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><button btn-bg-color="secondary" class="btnCurso">Conferir</button></a>
                        </div>
                    </div>
                <?php } ?>
            </div>
