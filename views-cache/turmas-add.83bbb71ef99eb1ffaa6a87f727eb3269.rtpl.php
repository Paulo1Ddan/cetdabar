                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="POST" action="/cetdabar/admin/class/class-add">
                                    <div class="card-body">
                                        <!-- Nome -->
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" required name="nometurma" id="nometurma" class="form-control" placeholder="Nome da Turma">
                                        </div>
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="date" disabled id="datacad" value="<?php echo htmlspecialchars( $todaydate, ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="form-control" placeholder="Data de cadastro">
                                        </div>
